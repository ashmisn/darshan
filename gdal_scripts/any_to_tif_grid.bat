...
set INPUT="C:\Users\merch\Documents\code\darshan\data\multiclass_new_dataset\uplarshi_multiclass.tif"
rem Set the desired output directory (make sure to change this path if needed)
set OUT_DIR="C:\Users\merch\Documents\code\darshan\data\multiclass_new_dataset\output_tiles"
