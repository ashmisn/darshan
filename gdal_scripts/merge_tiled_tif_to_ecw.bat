...
set TILE_DIR="D:\Documents\cyber\projects\darshan\code\data\Gujarat\tiles_output"

rem Set the output path for the merged image (you can change this to any format, e.g., GeoTIFF, JPEG, etc.)
set OUTPUT_FILE="D:\Documents\cyber\projects\darshan\code\data\Gujarat\merged_output.tif"
