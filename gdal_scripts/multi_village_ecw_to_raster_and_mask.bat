...
set VECTOR="D:\Documents\cyber\projects\darshan\repo\data\Gujarat\LalPur, Suragpur\Gujarat_Build_Up_Area_Type.shp"
set ECW="D:\Documents\cyber\projects\darshan\repo\data\Gujarat\Ortho_SURAGPUR(515578)_28_04_2022_3857.ecw"
