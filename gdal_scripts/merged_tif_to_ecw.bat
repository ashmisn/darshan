...
set INPUT_TIF="D:\Documents\cyber\projects\darshan\code\data\Gujarat\merged_output.tif"

rem Set the desired output ECW file path
set OUTPUT_ECW="D:\Documents\cyber\projects\darshan\code\data\Gujarat\merged_output.ecw"
